...
const Case = () => {
  return (
    <div className="flex flex-col w-full justify-center items-center  max-w-screen-xl  mx-auto  xl:mb-[10rem] ">
      ...
      >
        ...
        >
          ...
          <button className="dark:bg-[#f6e7e7] dark:text-black text-white bg-[#191A1A] gap-1 flex mt-[2rem]  py-4 px-4 rounded-[3rem] drop-shadow-md xl:hover:ml-3 hover:scale-110 hover:ease-in-out duration-500">
