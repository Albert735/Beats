...
const Navbar2 = ({ step }) => {
  return (
    <div className="flex flex-col xl:flex-row justify-between items-center w-[100%]  md:p-5">
      ...
      <div className="flex relative justify-between xl:justify-between items-start md:gap-[1rem] w-[23rem] md:w-[40rem] xl:w-[100dvw]  gap-9 p-4">
        <div className={`absolute top-[1.6rem] left-[2rem] md:top-[1.7rem] md:left-[3rem] justify-center ${step === 1 ? "w-[16rem] bg-slate-400" : ""} xl:justify- items-center h-1 border-2  border-blue-300 w-[34dvw] md:w-[33rem]  xl:w-[43dvw]`}></div>
